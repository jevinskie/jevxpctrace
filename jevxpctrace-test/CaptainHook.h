...
#define CHLogSource(args...)                                                                                           \
    NSLog(@CHAppName " @ " CHStringify(__LINE__) " in %s: %@", __FUNCTION__, [NSString stringWithFormat:args])
...
#define CHHook7(class, name1, name2, name3, name4, name5, name6, name7)                                                \
    CHHook_(class, name1##$##name2##$##name3##$##name4##$##name5##$##name6##$##name7##$)
#define CHHook8(class, name1, name2, name3, name4, name5, name6, name7, name8)                                         \
    CHHook_(class, name1##$##name2##$##name3##$##name4##$##name5##$##name6##$##name7##$##name8##$)
#define CHHook9(class, name1, name2, name3, name4, name5, name6, name7, name8, name9)                                  \
...
#define CHClassHook7(class, name1, name2, name3, name4, name5, name6, name7)                                           \
    CHHook_(class, name1##$##name2##$##name3##$##name4##$##name5##$##name6##$##name7##$)
#define CHClassHook8(class, name1, name2, name3, name4, name5, name6, name7, name8)                                    \
    CHHook_(class, name1##$##name2##$##name3##$##name4##$##name5##$##name6##$##name7##$##name8##$)
#define CHClassHook9(class, name1, name2, name3, name4, name5, name6, name7, name8, name9)                             \
    CHHook_(class, name1##$##name2##$##name3##$##name4##$##name5##$##name6##$##name7##$##name8##$##name9##$)
...
#endif
#define CHProfileScopeWithFormat(args...) CHProfileScopeWithString(([NSString stringWithFormat:args]))
#define CHProfileScope() CHProfileScopeWithFormat(@CHStringify(__LINE__) " in %s", __FUNCTION__)
